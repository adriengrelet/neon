...
TRANSLATIONS_ES = {'statusline.compact': 'HP:{hp} EN:{energy} HK:{hack} AL:{alarm} CR:{credits} FR:{fragments}/3',
 ...
 'profile.access_granted': 'Acceso al dataset hacker concedido... recuperando datos.',
 'profile.new_hacker': 'Nuevo hacker dentro del sistema... creando dataset.',
 'profile.title': '=== PERFIL HACKER ===',
 'profile.no_data': 'No hay datos de perfil disponibles.',
 'profile.name': 'Nombre: {value}',
 'profile.total_runs': 'Megastructuras infiltradas: {value}',
 'profile.megastructures': 'Megastructuras visitadas: {value}',
 'profile.wins': 'Victorias: {value}',
 'profile.losses': 'Derrotas: {value}',
 'profile.deaths': 'Muertes: {value}',
 'profile.abandons': 'Abandonos: {value}',
 'profile.play_time': 'Tiempo total de juego: {value}',
 'profile.hacks_success': 'Hacks exitosos: {value}',
 'profile.hacks_failed': 'Hacks fallidos: {value}',
 'profile.rooms_visited': 'Salas visitadas: {value}',
 'profile.fragments': 'Fragmentos ROM recogidos: {value}',
 'profile.last_status': 'Ultimo estado: {value}',
 'profile.bank_credits': 'Creditos en banco: {value}',
 'profile.active_structure': 'Estructura activa: {value}',
 'profile.next_structure': 'Proxima estructura: {value}',
 'profile.xp_total': 'XP total: {value} (+{gain} ultima partida)',
 'profile.bank_inventory': 'Inventario banco: {value}',
 'quest.new_mail_prompt': 'Tienes un nuevo mensaje del ciberespacio. Leer? (y/n) ',
 'quest.mail.title': '=== NUEVO MAIL SEGURO ===',
 'quest.mail.copied': '[Mail copiado en la consola] {path}',
 'quest.infiltrate_prompt': 'Quieres infiltrarla? (y/n) ',
 'quest.mission_pack': 'Paquete de mision transferido a tu perfil (CR + objetos).',
 'quest.mission_skipped': 'Mision ignorada. Inicio estandar.',
 'quest.mail.from': 'From',
 'quest.mail.to': 'To',
 'quest.mail.timestamp': 'Timestamp',
 'quest.mail.subject': 'Subject',
 'quest.mail.greeting': 'Operador {player_name},',
 'quest.mail.target': 'Objetivo confirmado: {title} ({structure_id}).',
 'quest.mail.objective': 'Objetivo: infiltrar, recoger 3 fragmentos de cryptodata y neutralizar el CORE.',
 'quest.mail.starter.title': 'Ayuda inicial transferida:',
 'quest.mail.starter.credits': '- Creditos: +{credits} CR',
 'quest.mail.starter.items': '- Objetos: {items}',
 'quest.mail.none': 'ninguno',
 'quest.mail.reply': 'Se recomienda responder con infiltracion inmediata.',
 'quest.mail.mission_id': 'Mission-ID',
 'quest.discovery.header': '[CRYPTODATA] Proximo objetivo identificado:',
 'quest.discovery.target': '- {structure_id} / {title}',
 'quest.discovery.note': '- nota de mision guardada: {path}',
 'quest.discovery.file.completed': 'Cryptodata completada desde {structure_id}',
 'quest.discovery.file.cleared': 'Objetivo actual neutralizado: {title}',
 'quest.discovery.file.next': 'Proxima megastructura identificada:',
 'quest.discovery.file.id': 'ID',
 'quest.discovery.file.name': 'Nombre',
 'quest.discovery.file.intel': 'Intel',
 'quest.discovery.file.no_intel': 'Sin intel disponible.',
 ...
 'prerun.shop.offer_prompt': 'Tienes {credits} CR, visitar la tienda pre-run? (y/n) ',
 'prerun.shop.title': '=== TIENDA PRE-RUN ===',
 'prerun.shop.credits': 'CR disponibles: {credits}',
 'prerun.shop.bank_inventory': 'Inventario banco: {value}',
 'prerun.shop.quit': '0. Salir',
 'prerun.shop.choice_prompt': 'Eleccion > ',
 'prerun.shop.invalid': 'Eleccion invalida.',
 'prerun.shop.insufficient': 'Creditos insuficientes.',
 'prerun.shop.purchase_ok': 'Compra confirmada: {item}',
 ...
 'shop.item.7': '7. Disipador energetico - 300 creditos: reduce a la mitad los costos EN de las acciones',
       'shop.item.8': '8. medkit - 100 creditos: agrega 1 medkit al inventario',
       'shop.item.9': '9. energy_cell - 100 creditos: agrega 1 energy_cell al inventario',
 'shop.item.0': '0. Salir',
 ...
 'shop.buy.7': 'Disipador energetico comprado! Los costos EN de las acciones ahora se reducen a la mitad.',
       'shop.buy.8': 'medkit comprado y agregado al inventario.',
       'shop.buy.9': 'energy_cell comprado y agregado al inventario.',
 'shop.invalid': 'Eleccion invalida o creditos insuficientes.',
       'shop.insufficient': 'Creditos insuficientes.',
 ...
 'intro.full': '\n'
               ...
               '\n'
               'Ejemplo tutorial (matriz ficticia):\n'
               '      1    2    3    4\n'
               ' A   9C   55   BD   E1\n'
               ' B   F2   AA   2D   6C\n'
               ' C   1D   B4   91   D9\n'
               ' D   0F   7A   C7   3F\n'
               '\n'
               '- Secuencia solicitada: AA -> 7A -> 3F\n'
               '- Paso 1: B2 (OK, B2 = AA)\n'
               '- Paso 2: D2 (OK, misma columna que B2, y D2 = 7A)\n'
               '- Paso 3: D4 (OK, misma fila que D2, y D4 = 3F)\n'
               '- Entrada final valida: B2 -> D2 -> D4\n'
               '\n'
               ...
               ' profile / pro : mostrar las estadisticas del perfil del jugador\n'
               ...
               ' console : abrir la consola personal\n'
               ' ssh <player>@console : abrir la consola personal (modo SSH)\n',
