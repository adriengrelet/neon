...
TRANSLATIONS_EN = {'statusline.compact': 'HP:{hp} EN:{energy} HK:{hack} AL:{alarm} CR:{credits} FR:{fragments}/3',
 ...
 'intro.full': '\n'
               ...
               '\n'
               'Tutorial example (fictional matrix):\n'
               '      1    2    3    4\n'
               ' A   9C   55   BD   E1\n'
               ' B   F2   AA   2D   6C\n'
               ' C   1D   B4   91   D9\n'
               ' D   0F   7A   C7   3F\n'
               '\n'
               '- Requested sequence: AA -> 7A -> 3F\n'
               '- Step 1: B2 (OK, B2 = AA)\n'
               '- Step 2: D2 (OK, same column as B2, and D2 = 7A)\n'
               '- Step 3: D4 (OK, same row as D2, and D4 = 3F)\n'
               '- Final valid input: B2 -> D2 -> D4\n'
               '\n'
