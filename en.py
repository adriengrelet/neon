...
TRANSLATIONS_EN = {'statusline.compact': 'HP:{hp} EN:{energy} HK:{hack} AL:{alarm} CR:{credits} FR:{fragments}/3',
 ...
 'profile.bank_credits': 'Bank credits: {value}',
 'profile.active_structure': 'Active structure: {value}',
 'profile.next_structure': 'Next structure: {value}',
 'profile.xp_total': 'Total XP: {value} (+{gain} last run)',
 'profile.bank_inventory': 'Bank inventory: {value}',
 'quest.new_mail_prompt': 'You have a new cyberspace message. Read it? (y/n) ',
 'quest.mail.title': '=== NEW SECURE MAIL ===',
 'quest.mail.copied': '[Mail copied to console] {path}',
 'quest.infiltrate_prompt': 'Do you want to infiltrate it? (y/n) ',
 'quest.mission_pack': 'Mission starter pack transferred to your profile (CR + items).',
 'quest.mission_skipped': 'Mission skipped. Standard launch.',
 'quest.mail.from': 'From',
 'quest.mail.to': 'To',
 'quest.mail.timestamp': 'Timestamp',
 'quest.mail.subject': 'Subject',
 'quest.mail.greeting': 'Operator {player_name},',
 'quest.mail.target': 'Confirmed target: {title} ({structure_id}).',
 'quest.mail.objective': 'Objective: infiltrate, collect 3 cryptodata fragments, and neutralize the CORE.',
 'quest.mail.starter.title': 'Starter package transferred:',
 'quest.mail.starter.credits': '- Credits: +{credits} CR',
 'quest.mail.starter.items': '- Items: {items}',
 'quest.mail.none': 'none',
 'quest.mail.reply': 'Immediate infiltration response recommended.',
 'quest.mail.mission_id': 'Mission-ID',
 'quest.discovery.header': '[CRYPTODATA] Next target identified:',
 'quest.discovery.target': '- {structure_id} / {title}',
 'quest.discovery.note': '- mission note saved: {path}',
 'quest.discovery.file.completed': 'Cryptodata completed from {structure_id}',
 'quest.discovery.file.cleared': 'Current target cleared: {title}',
 'quest.discovery.file.next': 'Next megastructure identified:',
 'quest.discovery.file.id': 'ID',
 'quest.discovery.file.name': 'Name',
 'quest.discovery.file.intel': 'Intel',
 'quest.discovery.file.no_intel': 'No intel available.',
 ...
 'help.commands': 'Commands: n s e w | scan/sc | echo/ec | hack/h | attack/at | take/t | use/u <item> | inventory/inv '
                  '| map/m | status/stat | profile/pro | fragments/fra | shop/sh | console | ssh <player>@console '
                  '| help/he | quit/q',
 'prerun.shop.offer_prompt': 'You have {credits} CR, visit pre-run shop? (y/n) ',
 'prerun.shop.title': '=== PRE-RUN SHOP ===',
 'prerun.shop.credits': 'Available CR: {credits}',
 'prerun.shop.bank_inventory': 'Bank inventory: {value}',
 'prerun.shop.quit': '0. Exit',
 'prerun.shop.choice_prompt': 'Choice > ',
 'prerun.shop.invalid': 'Invalid choice.',
 'prerun.shop.insufficient': 'Insufficient credits.',
 'prerun.shop.purchase_ok': 'Purchase confirmed: {item}',
 ...
 'shop.item.7': '7. Energy dissipator - 300 credits: halves EN costs for actions',
       'shop.item.8': '8. medkit - 100 credits: adds 1 medkit to inventory',
       'shop.item.9': '9. energy_cell - 100 credits: adds 1 energy_cell to inventory',
 'shop.item.0': '0. Exit',
 'shop.prompt': 'Choice > ',
 ...
 'shop.buy.7': 'Energy dissipator purchased! Action EN costs are now halved.',
       'shop.buy.8': 'medkit purchased and added to inventory.',
       'shop.buy.9': 'energy_cell purchased and added to inventory.',
 'shop.invalid': 'Invalid choice or insufficient credits.',
       'shop.insufficient': 'Insufficient credits.',
 ...
 'intro.full': '\n'
               ...
               ' console : open personal console\n'
               ' ssh <player>@console : open personal console (SSH mode)\n',
