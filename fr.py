...
TRANSLATIONS_FR = {'statusline.compact': 'HP:{hp} EN:{energy} HK:{hack} AL:{alarm} CR:{credits} FR:{fragments}/3',
 ...
 'profile.access_granted': 'Dataset hacker access granted... recuperation des donnees.',
 'profile.new_hacker': 'New hacker inside the system... creation du dataset.',
 'profile.title': '=== PROFIL HACKER ===',
 'profile.no_data': 'Aucune donnee profil disponible.',
 'profile.name': 'Nom: {value}',
 'profile.total_runs': 'Megastructures infiltrees: {value}',
 'profile.megastructures': 'Megastructures visitees: {value}',
 'profile.wins': 'Victoires: {value}',
 'profile.losses': 'Defaites: {value}',
 'profile.deaths': 'Morts: {value}',
 'profile.abandons': 'Abandons: {value}',
 'profile.play_time': 'Temps de jeu total: {value}',
 'profile.hacks_success': 'Hacks reussis: {value}',
 'profile.hacks_failed': 'Hacks rates: {value}',
 'profile.rooms_visited': 'Salles visitees: {value}',
 'profile.fragments': 'Fragments ROM collectes: {value}',
 'profile.last_status': 'Dernier statut: {value}',
 'profile.bank_credits': 'Credits banque: {value}',
 'profile.active_structure': 'Structure active: {value}',
 'profile.next_structure': 'Prochaine structure: {value}',
 'profile.xp_total': 'XP total: {value} (+{gain} dernier run)',
 'profile.bank_inventory': 'Inventaire banque: {value}',
 'quest.new_mail_prompt': 'Vous avez un nouveau message du cyberespace. Lire ? (y/n) ',
 'quest.mail.title': '=== NOUVEAU MAIL SECURISE ===',
 'quest.mail.copied': '[Mail copie dans la console] {path}',
 'quest.infiltrate_prompt': "Voulez-vous l'infiltrer ? (y/n) ",
 'quest.mission_pack': 'Aide de mission transferee dans votre profil (CR + items).',
 'quest.mission_skipped': 'Mission ignoree. Lancement en mode standard.',
 'quest.mail.from': 'From',
 'quest.mail.to': 'To',
 'quest.mail.timestamp': 'Timestamp',
 'quest.mail.subject': 'Subject',
 'quest.mail.greeting': 'Operateur {player_name},',
 'quest.mail.target': 'Cible confirmee: {title} ({structure_id}).',
 'quest.mail.objective': 'Objectif: infiltrer, collecter 3 fragments de cryptodata et neutraliser le CORE.',
 'quest.mail.starter.title': 'Aide de lancement transferee:',
 'quest.mail.starter.credits': '- Credits: +{credits} CR',
 'quest.mail.starter.items': '- Items: {items}',
 'quest.mail.none': 'aucun',
 'quest.mail.reply': 'Repondre par infiltration immediate recommande.',
 'quest.mail.mission_id': 'Mission-ID',
 'quest.discovery.header': '[CRYPTODATA] Prochaine cible identifiee:',
 'quest.discovery.target': '- {structure_id} / {title}',
 'quest.discovery.note': '- note de mission sauvegardee: {path}',
 'quest.discovery.file.completed': 'Cryptodata completee depuis {structure_id}',
 'quest.discovery.file.cleared': 'Cible actuelle neutralisee: {title}',
 'quest.discovery.file.next': 'Prochaine megastructure identifiee:',
 'quest.discovery.file.id': 'ID',
 'quest.discovery.file.name': 'Nom',
 'quest.discovery.file.intel': 'Renseignement',
 'quest.discovery.file.no_intel': 'Aucun renseignement disponible.',
 ...
 'help.commands': 'Commandes : n s e w | scan/sc | echo/ec | hack/h | attack/at | take/t | use/u <objet> | '
                  'inventory/inv | map/m | status/stat | profile/pro | fragments/fra | shop/sh | console | ssh '
                  '<player>@console | help/he | quit/q',
 'prerun.shop.offer_prompt': 'Vous avez {credits} CR, visiter la boutique de preparation ? (y/n) ',
 'prerun.shop.title': '=== PRE-RUN SHOP ===',
 'prerun.shop.credits': 'CR disponibles: {credits}',
 'prerun.shop.bank_inventory': 'Inventaire banque: {value}',
 'prerun.shop.quit': '0. Quitter',
 'prerun.shop.choice_prompt': 'Choix > ',
 'prerun.shop.invalid': 'Choix invalide.',
 'prerun.shop.insufficient': 'Credits insuffisants.',
 'prerun.shop.purchase_ok': 'Achat confirme: {item}',
 'prerun.shop.item.medkit': 'medkit',
 'prerun.shop.item.energy_cell': 'energy_cell',
 'shop.title': '=== MAGASIN ===',
 ...
 'shop.item.7': '7. Dissipateur énergétique - 300 crédits : divise par 2 les coûts en EN des actions',
       'shop.item.8': '8. medkit - 100 crédits : ajoute 1 medkit à l\'inventaire',
       'shop.item.9': '9. energy_cell - 100 crédits : ajoute 1 energy_cell à l\'inventaire',
 ...
 'shop.buy.7': 'Dissipateur énergétique acheté ! Les coûts EN des actions sont divisés par 2.',
       'shop.buy.8': 'medkit acheté et ajouté à l\'inventaire.',
       'shop.buy.9': 'energy_cell acheté et ajouté à l\'inventaire.',
 'shop.invalid': 'Choix invalide ou insuffisant de crédits.',
        'shop.insufficient': 'Credits insuffisants.',
 ...
 'intro.full': '\n'
               ...
               '\n'
               'Pour les hacks :\n'
               '- Un code à 3 valeurs HEXA doit être trouvé dans une matrice générée aléatoirement.\n'
               '- Plus ton hack est élevé, plus la matrice est petite.\n'
               '- Étape 1 : libre de trouver la bonne valeur HEXA du premier élément du code dans la matrice (qui doit correspondre à la première '
               ...
               ' D   0F   7A   C7   3F\n'
               '\n'
               '- Séquence demandée : AA -> 7A -> 3F\n'
               '- Étape 1 : B2 (OK, B2 = AA)\n'
               '- Étape 2 : D2 (OK, même colonne que B2, et D2 = 7A)\n'
               '- Étape 3 : D4 (OK, même ligne que D2, et D4 = 3F)\n'
               '- Entrée finale valide : B2 -> D2 -> D4\n'
               '\n'
               ...
               ' profile / pro : afficher les statistiques du profil joueur\n'
               ...
               ' console : ouvrir la console personnelle\n'
               ' ssh <player>@console : ouvrir la console personnelle (mode SSH)\n',
