...
MAIL_TEMPLATES = [
    {
        ...
        "body": "La nouvelle megastructure est deja sous protection active. Attends-toi a des contacts hostiles frequents.",
        "starter_credits": 180,
    ...
    },
    {
        ...
        "body": "Le batiment est segmente par des verrous hack superposes. Ne pars pas sans reserves.",
        "starter_credits": 220,
    ...
    },
    {
        ...
        "body": "Les noeuds de surveillance relaient les alertes tres vite. Chaque erreur coutera plus cher.",
        "starter_credits": 200,
    ...
    },
    {
        ...
        "body": "Peu d'objets recuperables sur place. Compense via la boutique avant insertion.",
        "starter_credits": 260,
    ...
    },
    {
        ...
        "body": "Beaucoup de terminaux exposes et de verrous associes. Profil ideal pour un specialist hack.",
        "starter_credits": 200,
    ...
    },
    {
        ...
        "body": "Une nouvelle megastructure vient d'etre detectee. Si elle passe en production, des quartiers entiers perdront leurs droits d'acces.",
        "starter_credits": 240,
        "starter_items": ["medkit", "energy_cell"],
    ...
    },
    {
        ...
        "body": "Tu es notre meilleur point d'entree. Infiltrer cette structure donnera de l'air a la resistance civile.",
        "starter_credits": 230,
    ...
    },
    {
        ...
        "body": "Les lignes d'alimentation sont instables. Chaque action active peut couter plus d'energie que prevu.",
        "starter_credits": 260,
    ...
    },
    {
        ...
        "body": "La cellule centrale signale un CORE Sentinel renforce. L'engagement final sera plus dur.",
        "starter_credits": 280,
    ...
    },
    {
        ...
        "body": "La cartographie interne indique des depots utilitaires hors circuit. Le scan devrait etre rentable.",
        "starter_credits": 170,
        "starter_items": ["medkit"],
    ...
    },
    {
        ...
        "body": "Les couloirs critiques sont fortement verrouilles, mais la patrouille de gardes est moins dense.",
        "starter_credits": 240,
        "starter_items": ["energy_cell", "energy_cell"],
    ...
    },
    {
        ...
        "body": "Le systeme de renfort repond vite aux anomalies. Evite les echecs successifs.",
        "starter_credits": 250,
        "starter_items": ["medkit", "energy_cell"],
        "modifiers": {
            "alarm_step": 2,
...
MAIL_TEMPLATE_TRANSLATIONS = {
    "en": {
        "NODE-HERMES": {
            ...
            "body": "The new megastructure is already under active protection. Expect frequent hostile contact.",
        },
        "SIGMA LIAISON": {
            "subject": "Red channel: locked architecture",
            "body": "The building is segmented by stacked hack locks. Do not deploy without reserves.",
        },
        "CROW-NET": {
            "subject": "Intercept: accelerated alert propagation",
            "body": "Surveillance nodes relay alerts very quickly. Every mistake will cost more.",
        },
        "AZUR PROXY": {
            "subject": "Briefing: low-loot zone",
            "body": "Few recoverable items on site. Compensate in the shop before insertion.",
        },
        "BLACK TRACE": {
            "subject": "Field file: terminal-heavy corridors",
            "body": "Many exposed terminals and associated locks. Ideal profile for hack specialists.",
        },
        "MERCURY HAND": {
            "subject": "Short infiltration window",
            "body": "Your entry slot is limited. The core must fall fast.",
        },
        "ECHO-DELTA": {
            "subject": "Compiled signal: partially exposed core",
            "body": "Surface security is aggressive, but some technical lanes remain open.",
        },
        "NIGHT COURRIER": {
            "subject": "Civic priority: digital rights at risk",
            "body": "A new megastructure has been detected. If it goes live, entire districts lose access rights.",
        },
        "ARCHIVE NULL": {
            "subject": "Tactical frame: random patrols",
            "body": "Guards rotate without pattern. Prepare both offensive and defensive options.",
        },
        "FREELINE": {
            "subject": "Public signal: infiltration recommended",
            "body": "You are our best entry point. Infiltrating this structure will relieve civilian pressure.",
        },
        "POLAR SECTOR": {
            "subject": "Likely energy overload",
            "body": "Power lines are unstable. Active actions may cost more energy than expected.",
        },
        "WARDEN LEAK": {
            "subject": "Reinforced Sentinel core",
            "body": "Central cell reports a reinforced CORE Sentinel. The final engagement will be harder.",
        },
        "DEEP CARTO": {
            "subject": "Utility caches detected",
            "body": "Internal mapping shows off-grid utility depots. Scan should be profitable.",
        },
        "LOCKSPINE": {
            "subject": "Neuro-crypt lock stacking",
            "body": "Critical lanes are heavily locked, but guard density is lower.",
        },
        "RED SPARK": {
            "subject": "Tactical reinforcement propagation",
            "body": "Reinforcement systems react quickly to anomalies. Avoid chained failures.",
        },
    },
    "es": {
        "NODE-HERMES": {
            "subject": "Alerta prioritaria: alta presencia de guardias",
            "body": "La nueva megastructura ya esta bajo proteccion activa. Espera contactos hostiles frecuentes.",
        },
        "SIGMA LIAISON": {
            "subject": "Canal rojo: arquitectura bloqueada",
            "body": "El edificio esta segmentado por bloqueos hack superpuestos. No entres sin reservas.",
        },
        "CROW-NET": {
            "subject": "Intercepcion: propagacion acelerada de alerta",
            "body": "Los nodos de vigilancia retransmiten alertas muy rapido. Cada error costara mas.",
        },
        "AZUR PROXY": {
            "subject": "Briefing: zona con poco loot",
            "body": "Hay pocos objetos recuperables en sitio. Compensalo en la tienda antes de entrar.",
        },
        "BLACK TRACE": {
            "subject": "Dossier de campo: corredores con terminales",
            "body": "Muchos terminales expuestos y bloqueos asociados. Perfil ideal para especialistas hack.",
        },
        "MERCURY HAND": {
            "subject": "Ventana de infiltracion corta",
            "body": "Tu ventana de entrada es limitada. El core debe caer rapido.",
        },
        "ECHO-DELTA": {
            "subject": "Senal compilada: nucleo parcialmente expuesto",
            "body": "La seguridad superficial es agresiva, pero algunos corredores tecnicos siguen abiertos.",
        },
        "NIGHT COURRIER": {
            "subject": "Prioridad civica: derechos digitales en riesgo",
            "body": "Se detecto una nueva megastructura. Si entra en produccion, barrios enteros perderan derechos de acceso.",
        },
        "ARCHIVE NULL": {
            "subject": "Trama tactica: patrullas aleatorias",
            "body": "Los guardias cambian rutas sin patron. Prepara opciones ofensivas y defensivas.",
        },
        "FREELINE": {
            "subject": "Senal publica: infiltracion recomendada",
            "body": "Eres nuestro mejor punto de entrada. Infiltrar esta estructura dara aire a la resistencia civil.",
        },
        "POLAR SECTOR": {
            "subject": "Posible sobrecarga energetica",
            "body": "Las lineas de energia son inestables. Las acciones activas pueden costar mas energia de lo previsto.",
        },
        "WARDEN LEAK": {
            "subject": "Nucleo Sentinel reforzado",
            "body": "La celda central reporta un CORE Sentinel reforzado. El enfrentamiento final sera mas duro.",
        },
        "DEEP CARTO": {
            "subject": "Caches utilitarios detectados",
            "body": "El mapeo interno indica depositos utilitarios fuera de red. El scan deberia rendir.",
        },
        "LOCKSPINE": {
            "subject": "Superposicion de bloqueos neurocripticos",
            "body": "Los corredores criticos estan muy bloqueados, pero la densidad de guardias es menor.",
        },
        "RED SPARK": {
            "subject": "Propagacion tactica de refuerzos",
            "body": "El sistema de refuerzos responde rapido a anomalias. Evita fallos consecutivos.",
        },
    },
    "it": {
        "NODE-HERMES": {
            "subject": "Allerta prioritaria: alta presenza di guardie",
            "body": "La nuova megastruttura e gia sotto protezione attiva. Aspettati contatti ostili frequenti.",
        },
        "SIGMA LIAISON": {
            "subject": "Canale rosso: architettura bloccata",
            "body": "L'edificio e segmentato da blocchi hack sovrapposti. Non entrare senza riserve.",
        },
        "CROW-NET": {
            "subject": "Intercettazione: propagazione allarmi accelerata",
            "body": "I nodi di sorveglianza rilanciano gli allarmi molto in fretta. Ogni errore costera di piu.",
        },
        "AZUR PROXY": {
            "subject": "Briefing: area povera di loot",
            "body": "Pochi oggetti recuperabili sul posto. Compensa nel negozio prima dell'inserzione.",
        },
        "BLACK TRACE": {
            "subject": "Dossier operativo: corridoi pieni di terminali",
            "body": "Molti terminali esposti e blocchi associati. Profilo ideale per specialisti hack.",
        },
        "MERCURY HAND": {
            "subject": "Finestra di infiltrazione breve",
            "body": "Lo slot di ingresso e limitato. Il core deve cadere in fretta.",
        },
        "ECHO-DELTA": {
            "subject": "Segnale compilato: nucleo parzialmente esposto",
            "body": "La sicurezza di superficie e aggressiva, ma alcuni corridoi tecnici restano aperti.",
        },
        "NIGHT COURRIER": {
            "subject": "Priorita civica: diritti digitali a rischio",
            "body": "Una nuova megastruttura e stata rilevata. Se entra in produzione, interi quartieri perderanno diritti di accesso.",
        },
        "ARCHIVE NULL": {
            "subject": "Schema tattico: pattuglie casuali",
            "body": "Le guardie cambiano rotta senza schema. Prepara opzioni offensive e difensive.",
        },
        "FREELINE": {
            "subject": "Segnale pubblico: infiltrazione raccomandata",
            "body": "Sei il nostro miglior punto di ingresso. Infiltrare questa struttura dara respiro alla resistenza civile.",
        },
        "POLAR SECTOR": {
            "subject": "Probabile sovraccarico energetico",
            "body": "Le linee di alimentazione sono instabili. Le azioni attive possono costare piu energia del previsto.",
        },
        "WARDEN LEAK": {
            "subject": "Nucleo Sentinel rinforzato",
            "body": "La cella centrale segnala un CORE Sentinel rinforzato. Lo scontro finale sara piu duro.",
        },
        "DEEP CARTO": {
            "subject": "Cache utilitarie rilevate",
            "body": "La mappatura interna mostra depositi utilitari fuori rete. Lo scan dovrebbe rendere bene.",
        },
        "LOCKSPINE": {
            "subject": "Sovrapposizione di blocchi neuro-criptati",
            "body": "I corridoi critici sono molto bloccati, ma la densita delle guardie e piu bassa.",
        },
        "RED SPARK": {
            "subject": "Propagazione tattica dei rinforzi",
            "body": "Il sistema di rinforzi reagisce rapidamente alle anomalie. Evita fallimenti in catena.",
        },
    },
}
...
def unlock_next_structure(profile, path, save_profile, structures, current_structure_id):
    ...
    unvisited = [s for s in structures if s.get("id") not in visited]
    if unvisited:
