...
TRANSLATIONS_IT = {'statusline.compact': 'HP:{hp} EN:{energy} HK:{hack} AL:{alarm} CR:{credits} FR:{fragments}/3',
 ...
 'profile.access_granted': 'Accesso dataset hacker autorizzato... recupero dati in corso.',
 'profile.new_hacker': 'Nuovo hacker nel sistema... creazione dataset.',
 'profile.title': '=== PROFILO HACKER ===',
 'profile.no_data': 'Nessun dato profilo disponibile.',
 'profile.name': 'Nome: {value}',
 'profile.total_runs': 'Megastrutture infiltrate: {value}',
 'profile.megastructures': 'Megastrutture visitate: {value}',
 'profile.wins': 'Vittorie: {value}',
 'profile.losses': 'Sconfitte: {value}',
 'profile.deaths': 'Morti: {value}',
 'profile.abandons': 'Abbandoni: {value}',
 'profile.play_time': 'Tempo totale di gioco: {value}',
 'profile.hacks_success': 'Hack riusciti: {value}',
 'profile.hacks_failed': 'Hack falliti: {value}',
 'profile.rooms_visited': 'Stanze visitate: {value}',
 'profile.fragments': 'Frammenti ROM raccolti: {value}',
 'profile.last_status': 'Ultimo stato: {value}',
 'profile.bank_credits': 'Crediti banca: {value}',
 'profile.active_structure': 'Struttura attiva: {value}',
 'profile.next_structure': 'Prossima struttura: {value}',
 'profile.xp_total': 'XP totale: {value} (+{gain} ultimo run)',
 'profile.bank_inventory': 'Inventario banca: {value}',
 'quest.new_mail_prompt': 'Hai un nuovo messaggio dal cyberspazio. Leggerlo? (y/n) ',
 'quest.mail.title': '=== NUOVA MAIL SICURA ===',
 'quest.mail.copied': '[Mail copiata nella console] {path}',
 'quest.infiltrate_prompt': 'Vuoi infiltrarla? (y/n) ',
 'quest.mission_pack': 'Pacchetto missione trasferito al profilo (CR + oggetti).',
 'quest.mission_skipped': 'Missione ignorata. Avvio standard.',
 'quest.mail.from': 'From',
 'quest.mail.to': 'To',
 'quest.mail.timestamp': 'Timestamp',
 'quest.mail.subject': 'Subject',
 'quest.mail.greeting': 'Operatore {player_name},',
 'quest.mail.target': 'Obiettivo confermato: {title} ({structure_id}).',
 'quest.mail.objective': 'Obiettivo: infiltrare, raccogliere 3 frammenti cryptodata e neutralizzare il CORE.',
 'quest.mail.starter.title': 'Pacchetto iniziale trasferito:',
 'quest.mail.starter.credits': '- Crediti: +{credits} CR',
 'quest.mail.starter.items': '- Oggetti: {items}',
 'quest.mail.none': 'nessuno',
 'quest.mail.reply': 'Risposta con infiltrazione immediata consigliata.',
 'quest.mail.mission_id': 'Mission-ID',
 'quest.discovery.header': '[CRYPTODATA] Prossimo bersaglio identificato:',
 'quest.discovery.target': '- {structure_id} / {title}',
 'quest.discovery.note': '- nota missione salvata: {path}',
 'quest.discovery.file.completed': 'Cryptodata completata da {structure_id}',
 'quest.discovery.file.cleared': 'Bersaglio attuale neutralizzato: {title}',
 'quest.discovery.file.next': 'Prossima megastruttura identificata:',
 'quest.discovery.file.id': 'ID',
 'quest.discovery.file.name': 'Nome',
 'quest.discovery.file.intel': 'Intel',
 'quest.discovery.file.no_intel': 'Nessun intel disponibile.',
 ...
 'prerun.shop.offer_prompt': 'Hai {credits} CR, visitare il negozio pre-run? (y/n) ',
 'prerun.shop.title': '=== NEGOZIO PRE-RUN ===',
 'prerun.shop.credits': 'CR disponibili: {credits}',
 'prerun.shop.bank_inventory': 'Inventario banca: {value}',
 'prerun.shop.quit': '0. Esci',
 'prerun.shop.choice_prompt': 'Scelta > ',
 'prerun.shop.invalid': 'Scelta non valida.',
 'prerun.shop.insufficient': 'Crediti insufficienti.',
 'prerun.shop.purchase_ok': 'Acquisto confermato: {item}',
 ...
 'shop.item.7': '7. Dissipatore energetico - 300 crediti: dimezza i costi EN delle azioni',
       'shop.item.8': '8. medkit - 100 crediti: aggiunge 1 medkit all\'inventario',
       'shop.item.9': '9. energy_cell - 100 crediti: aggiunge 1 energy_cell all\'inventario',
 'shop.item.0': '0. Esci',
 'shop.prompt': 'Scelta > ',
 ...
 'shop.buy.7': 'Dissipatore energetico acquistato! I costi EN delle azioni sono dimezzati.',
       'shop.buy.8': 'medkit acquistato e aggiunto all\'inventario.',
       'shop.buy.9': 'energy_cell acquistato e aggiunto all\'inventario.',
 'shop.invalid': 'Scelta non valida o crediti insufficienti.',
       'shop.insufficient': 'Crediti insufficienti.',
 ...
 'intro.full': '\n'
               ...
               ' profile / pro : mostrare le statistiche del profilo giocatore\n'
               ...
               ' console : aprire la console personale\n'
               ' ssh <player>@console : aprire la console personale (modalita SSH)\n',
